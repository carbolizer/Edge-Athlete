...
<!-- route:system-status:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | 🔒 coach only |
| **Handler** | `system_status` |
<!-- route:system-status:end -->
...
<!-- route:system-wifi-password:start -->
| | |
|---|---|
| **Methods** | `POST` |
| **Access** | 🔒 coach only |
| **Handler** | `change_wifi_password` |
<!-- route:system-wifi-password:end -->
...
<!-- route:racks-racknumber:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | open — no login |
| **Handler** | `rack_racknumber` |
<!-- route:racks-racknumber:end -->
...
<!-- route:racks-unassigned:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | 🔒 coach only |
| **Handler** | `racks_unassigned` |
<!-- route:racks-unassigned:end -->
...
<!-- route:racks-rack-number-checkin:start -->
| | |
|---|---|
| **Methods** | `POST` |
| **Access** | open — no login |
| **Handler** | `rack_checkin` |
<!-- route:racks-rack-number-checkin:end -->
...
<!-- route:racks-rack-number-checkins:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | open — no login |
| **Handler** | `rack_checkins` |
<!-- route:racks-rack-number-checkins:end -->
...
<!-- route:racks-device-id:start -->
| | |
|---|---|
| **Methods** | `PATCH` |
| **Access** | 🔒 coach only |
| **Handler** | `rack_assign` |
<!-- route:racks-device-id:end -->
...
<!-- route:nodes-node-id:start -->
| | |
|---|---|
| **Methods** | `PATCH` |
| **Access** | 🔒 coach only |
| **Handler** | `node_detail` |
<!-- route:nodes-node-id:end -->
...
<!-- route:athletes-athlete-id:start -->
| | |
|---|---|
| **Methods** | `GET,PATCH` |
| **Access** | 🔒 coach only |
| **Handler** | `athlete_detail` |
<!-- route:athletes-athlete-id:end -->
...
<!-- route:training-groups:start -->
| | |
|---|---|
| **Methods** | `GET,POST` |
| **Access** | 🔒 coach only |
| **Handler** | `training_groups_view` |
<!-- route:training-groups:end -->
...
<!-- route:training-groups-group-id-athletes:start -->
| | |
|---|---|
| **Methods** | `GET,POST,DELETE` |
| **Access** | 🔒 coach only |
| **Handler** | `training_group_athletes_view` |
<!-- route:training-groups-group-id-athletes:end -->
...
<!-- route:training-groups-group-id-coaches:start -->
| | |
|---|---|
| **Methods** | `GET,POST,PATCH,DELETE` |
| **Access** | 🔒 coach only |
| **Handler** | `training_group_coaches_view` |
<!-- route:training-groups-group-id-coaches:end -->
...
<!-- route:athletes-athlete-id-program:start -->
| | |
|---|---|
| **Methods** | `GET,PUT,DELETE` |
| **Access** | 🔒 coach only |
| **Handler** | `athlete_program_view` |
<!-- route:athletes-athlete-id-program:end -->
...
<!-- route:athletes-athlete-id-program-exercises-exercise-id-override:start -->
| | |
|---|---|
| **Methods** | `GET,PUT,DELETE` |
| **Access** | 🔒 coach only |
| **Handler** | `athlete_exercise_override_view` |
<!-- route:athletes-athlete-id-program-exercises-exercise-id-override:end -->
...
<!-- route:block-categories:start -->
| | |
|---|---|
| **Methods** | `GET,POST` |
| **Access** | 🔒 coach only |
| **Handler** | `block_categories_view` |
<!-- route:block-categories:end -->
...
<!-- route:training-blocks:start -->
| | |
|---|---|
| **Methods** | `GET,POST` |
| **Access** | 🔒 coach only |
| **Handler** | `training_blocks_view` |
<!-- route:training-blocks:end -->
...
<!-- route:training-blocks-block-id:start -->
| | |
|---|---|
| **Methods** | `GET,PATCH` |
| **Access** | 🔒 coach only |
| **Handler** | `training_block_detail` |
<!-- route:training-blocks-block-id:end -->
...
<!-- route:training-blocks-block-id-workouts:start -->
| | |
|---|---|
| **Methods** | `GET,POST` |
| **Access** | 🔒 coach only |
| **Handler** | `training_block_workouts_view` |
<!-- route:training-blocks-block-id-workouts:end -->
...
<!-- route:training-blocks-block-id-workout-order:start -->
| | |
|---|---|
| **Methods** | `PUT` |
| **Access** | 🔒 coach only |
| **Handler** | `training_block_workout_order` |
<!-- route:training-blocks-block-id-workout-order:end -->
...
<!-- route:training-blocks-block-id-workouts-workout-id:start -->
| | |
|---|---|
| **Methods** | `PATCH,DELETE` |
| **Access** | 🔒 coach only |
| **Handler** | `training_block_workout_detail` |
<!-- route:training-blocks-block-id-workouts-workout-id:end -->
...
<!-- route:training-blocks-block-id-workouts-workout-id-exercise-order:start -->
| | |
|---|---|
| **Methods** | `PUT` |
| **Access** | 🔒 coach only |
| **Handler** | `training_block_exercise_order` |
<!-- route:training-blocks-block-id-workouts-workout-id-exercise-order:end -->
...
<!-- route:training-blocks-block-id-workouts-workout-id-exercises-exercise-id:start -->
| | |
|---|---|
| **Methods** | `PATCH,DELETE` |
| **Access** | 🔒 coach only |
| **Handler** | `training_block_exercise_detail` |
<!-- route:training-blocks-block-id-workouts-workout-id-exercises-exercise-id:end -->
...
<!-- route:training-programs:start -->
| | |
|---|---|
| **Methods** | `GET,POST` |
| **Access** | 🔒 coach only |
| **Handler** | `training_programs_view` |
<!-- route:training-programs:end -->
...
<!-- route:training-programs-program-id-promote:start -->
| | |
|---|---|
| **Methods** | `POST` |
| **Access** | 🔒 coach only |
| **Handler** | `training_program_promote` |
<!-- route:training-programs-program-id-promote:end -->
...
<!-- route:scheduled-sessions:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | 🔒 coach only |
| **Handler** | `scheduled_sessions_view` |
<!-- route:scheduled-sessions:end -->
...
<!-- route:scheduled-sessions-slot-id:start -->
| | |
|---|---|
| **Methods** | `GET,PATCH` |
| **Access** | 🔒 coach only |
| **Handler** | `scheduled_session_detail` |
<!-- route:scheduled-sessions-slot-id:end -->
...
<!-- route:scheduled-sessions-slot-id-session:start -->
| | |
|---|---|
| **Methods** | `POST` |
| **Access** | 🔒 coach only |
| **Handler** | `scheduled_session_create_session` |
<!-- route:scheduled-sessions-slot-id-session:end -->
...
<!-- route:room-state:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | open — no login |
| **Handler** | `room_state` |
<!-- route:room-state:end -->
...
<!-- route:sessions-active:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | open — no login |
| **Handler** | `sessions_active` |
<!-- route:sessions-active:end -->
...
<!-- route:sessions-active-athlete-athlete-id-progress:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | open — no login |
| **Handler** | `athlete_progress` |
<!-- route:sessions-active-athlete-athlete-id-progress:end -->
...
<!-- route:sessions-active-status:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | open — no login |
| **Handler** | `session_status` |
<!-- route:sessions-active-status:end -->
...
<!-- route:sessions-session-id:start -->
| | |
|---|---|
| **Methods** | `PATCH` |
| **Access** | 🔒 coach only |
| **Handler** | `session_detail` |
<!-- route:sessions-session-id:end -->
...
<!-- route:sessions-session-id-participation:start -->
| | |
|---|---|
| **Methods** | `GET,POST,DELETE` |
| **Access** | 🔒 coach only |
| **Handler** | `session_participation_view` |
<!-- route:sessions-session-id-participation:end -->
...
<!-- route:sessions-session-id-start:start -->
| | |
|---|---|
| **Methods** | `POST` |
| **Access** | 🔒 coach only |
| **Handler** | `session_start` |
<!-- route:sessions-session-id-start:end -->
...
<!-- route:prescriptions:start -->
| | |
|---|---|
| **Methods** | `GET,POST` |
| **Access** | open — no login |
| **Handler** | `prescriptions_view` |
<!-- route:prescriptions:end -->
...
<!-- route:reports-report-id:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | 🔒 coach only |
| **Handler** | `report_detail_view` |
<!-- route:reports-report-id:end -->
...
<!-- route:reports-report-id-pdf:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | 🔒 coach only |
| **Handler** | `report_pdf_view` |
<!-- route:reports-report-id-pdf:end -->
...
<!-- route:reference-maxes:start -->
| | |
|---|---|
| **Methods** | `POST` |
| **Access** | 🔒 coach only |
| **Handler** | `reference_maxes_view` |
<!-- route:reference-maxes:end -->
...
<!-- route:sets-set-id-complete:start -->
| | |
|---|---|
| **Methods** | `POST` |
| **Access** | open — no login |
| **Handler** | `set_complete` |
<!-- route:sets-set-id-complete:end -->
...
<!-- route:analytics-session-session-id:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | 🔒 coach only |
| **Handler** | `analytics_session` |
<!-- route:analytics-session-session-id:end -->
...
<!-- route:analytics-athlete-athlete-id:start -->
| | |
|---|---|
| **Methods** | `GET` |
| **Access** | 🔒 coach only |
| **Handler** | `analytics_athlete` |
<!-- route:analytics-athlete-athlete-id:end -->
...
<!-- route:imports-preview:start -->
| | |
|---|---|
| **Methods** | `POST` |
| **Access** | 🔒 coach only |
| **Handler** | `import_preview` |
<!-- route:imports-preview:end -->
