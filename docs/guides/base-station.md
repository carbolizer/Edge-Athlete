...
The whole system runs as one Docker stack on the base station. There is no cloud,
no internet dependency, and no subscription — the base station broadcasts its own private
