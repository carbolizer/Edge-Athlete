...
function CoachView({ monitor, accessToken, onLogout }) {
  ...
  useEffect(()=>{if(selectedRackNumber&&!roomState?.racks.some(r=>r.rack_number===selectedRackNumber))setSelectedRackNumber(null);},[roomState,selectedRackNumber]);
