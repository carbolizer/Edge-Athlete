...
**Demo cut (shipped):** `/coach` currently uses dropdown-and-assign instead of
drag-and-drop; the shared DnD component and group/block/session drill-down stay
out of scope for that cut.
